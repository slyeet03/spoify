...
pub struct UserSavedArtist {
    ...
    pub track_names: Vec<String>,
    pub track_album: Vec<String>,
    pub track_duration: Vec<i64>,
    pub track_index: usize,
    pub track_state: TableState,
    pub track_display: bool,
    pub track_selected: bool,
    pub current_artist_selected: bool,
    pub track_links: Vec<String>,
}
...
pub struct NewRelease {
    ...
    pub current_album_link: String,
    pub index: usize,
    pub track_names: Vec<String>,
    pub artist_names: Vec<String>,
    pub durations_ms: Vec<i64>,
    pub spotify_urls: Vec<String>,
...
impl Default for NewRelease {
    fn default() -> Self {
        Self {
            ...
            album_state: TableState::default(),
            album_links: Vec::new(),
            current_album: String::new(),
            current_album_link: String::new(),
            track_names: Vec::new(),
            artist_names: Vec::new(),
            durations_ms: Vec::new(),
            spotify_urls: Vec::new(),
