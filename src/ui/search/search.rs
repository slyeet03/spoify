...
pub fn render_search(
    ...
    let search_block = Block::default()
        ...
        .border_style(Style::new().fg(app.search_border_color))
        .style(Style::default().bg(app.search_background_color));
    ...
    let album_block = Block::default()
        ...
        .border_style(if app.selected_album_in_search_result {
            Style::default().fg(app.search_border_color)
        } else {
            Style::default()
        })
        .style(Style::default().bg(app.search_background_color));
    ...
    let search_input = Paragraph::new(app.input.as_str())
        .style(match app.input_mode {
            ...
            InputMode::Editing => Style::default().fg(app.search_border_color),
    ...
    match app.input_mode {
        ...
        InputMode::SearchResults if app.search_results_rendered => {
            ...
            let album_list = List::new(album_names_list)
                ...
                .highlight_style(Style::default().fg(app.search_highlight_color));
