...
pub fn render_default_new_releases(
    ...
    let new_releases_name = convert_to_list(&newrelease.name);
...
pub fn render_new_releases(
    ...
    let current_new_release_name = (&newrelease.current_album).to_string();
    ...
    let current_new_release_block = Block::default()
        ...
        .border_style(if newrelease.album_selected {
    ...
    if newrelease.display {
        ...
        let new_release_tracks_table = new_release_table_ui(
            ...
            newrelease.artist_names.clone(),
            newrelease.durations_ms.clone(),
