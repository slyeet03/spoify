...
#[tokio::main]
pub async fn fetch_playlists_tracks(app: &mut App, userplaylist: &mut UserPlaylist) -> Result<(), ClientError> {
    ...
    let playlist_url = userplaylist.selected_playlist_uri.as_str();
