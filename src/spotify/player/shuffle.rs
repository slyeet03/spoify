...
#[tokio::main]
pub async fn toogle_shuffle(app: &mut App,currentlyplaying: &mut UserCurrentlyPlaying) -> Result<(), ClientError> {
    ...
    let result = spotify.shuffle(currentlyplaying.is_shuffle, device_id);
