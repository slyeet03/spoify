...
- **Bug**: Fixed proportions of layour are causing issues with potraying all the info
  - Status: Confirmed
  - Source: Discovered during testing
  - Notes: On smaller screen devices the player bar and search bar becomes invisible
